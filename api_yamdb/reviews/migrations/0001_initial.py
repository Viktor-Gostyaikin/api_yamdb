# Generated by Django 2.2.16 on 2021-10-06 13:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='title_id_reviews', to='reviews.Title')),
            ],
        ),
        migrations.CreateModel(
            name='Genre_Title',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('genre_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='ganre', to='reviews.Genre')),
                ('title_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='titles', to='reviews.Title')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
